...
<img width="1366" height="768" alt="image" src="https://github.com/user-attachments/assets/733bb285-0ea3-4245-a68b-cd5b8beb03fc" />
...
The Amazon RDS MariaDB instance requires encrypted (SSL/TLS) connections by default. Before connecting, you must download the Amazon RDS Certificate Authority (CA) bundle.

To download the RDS CA certificate bundle, run the following command:
